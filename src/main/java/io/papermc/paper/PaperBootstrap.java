...
public class PaperBootstrap {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 3. 启动 OpenClaw (AI 大脑)
            // 解决 "no token is configured" 报错：同时注入新旧两种 Token 变量
            ...
            // --- 🚨 2026 版核心环境变量 (修复 Token 报错) ---
            cEnv.put("PORT", "18789"); 
            cEnv.put("OPENCLAW_TOKEN", "mytoken123");         // 兼容旧版
            cEnv.put("OPENCLAW_GATEWAY_TOKEN", "mytoken123"); // 👈 适配新版核心要求
            
            cEnv.put("OPENCLAW_AI_PROVIDER", "google"); 
            cEnv.put("OPENCLAW_AI_API_KEY", "AIzaSyBzv_a-Q9u2TF1FVh58DT0yOJQPEMfJtqQ"); // 👈 爹！这里填入 Key
            ...
            System.out.println("✅ [胜利时刻] 系统已全量进入启动序列！");
